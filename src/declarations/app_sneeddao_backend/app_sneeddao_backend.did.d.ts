...
export interface AppSneedDaoBackend {
  ...
  'get_ban_log' : ActorMethod<[], Result_6>,
  'get_banned_users' : ActorMethod<[], Result_10>,
  ...
  >,
  'get_canister_info' : ActorMethod<[Principal], Result_9>,
  ...
  >,
  'get_my_settings' : ActorMethod<[], UserSettings>,
  ...
  'set_jailbreak_fee_settings' : ActorMethod<
    ...
    Result_2
  >,
  'set_my_settings' : ActorMethod<[UserSettingsUpdate], Result_3>,
...
export type Result_1 = { 'ok' : string } |
  { 'err' : string };
export type Result_10 = { 'ok' : Array<[Principal, bigint]> } |
  { 'err' : string };
export type Result_2 = { 'ok' : null } |
  { 'err' : string };
export type Result_3 = { 'ok' : UserSettings } |
  { 'err' : string };
export type Result_4 = { 'ok' : WhitelistedToken } |
  { 'err' : string };
export type Result_5 = { 'ok' : Array<Neuron> } |
  { 'err' : string };
export type Result_6 = { 'ok' : Array<BanLogEntry> } |
  { 'err' : string };
...
export interface UserSettings {
  ...
  'canister_manager_cycle_threshold_orange' : bigint,
  ...
  'neuron_manager_cycle_threshold_red' : bigint,
  'notify_collectibles' : boolean,
  'neuron_color_coding' : boolean,
  'particle_effects_enabled' : boolean,
  'swap_slippage_tolerance' : number,
  'notify_updates' : boolean,
  'notify_messages' : boolean,
  'notify_tips' : boolean,
  'canister_manager_cycle_threshold_red' : bigint,
  'frontend_update_countdown_sec' : bigint,
  'notify_replies' : boolean,
  'notify_low_cycles' : boolean,
  'frontend_update_check_interval_sec' : bigint,
  'frontend_clear_cache_on_update' : boolean,
