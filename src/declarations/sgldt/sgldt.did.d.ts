...
export interface _SERVICE {
  'admin_collect_fees' : ActorMethod<[], Result_1>,
  'admin_update_authorized_fee_collector' : ActorMethod<[Principal], boolean>,
  'admin_update_fee_collector' : ActorMethod<[Principal], boolean>,
  'admin_update_gldt_conversion_fee' : ActorMethod<[bigint], boolean>,
  'admin_update_gldt_transaction_fee' : ActorMethod<[bigint], boolean>,
  ...
  'get_accumulated_fees' : ActorMethod<[], bigint>,
  'get_authorized_fee_collector' : ActorMethod<[], Principal>,
  'get_fee_breakdown' : ActorMethod<
    [],
    {
      'sgldt_transfer_fee' : bigint,
      'gldt_ledger_fee' : bigint,
      'canister_withdraw_fee' : bigint,
    }
  >,
  'get_fee_collector' : ActorMethod<[], Principal>,
  'get_fee_stats' : ActorMethod<
    [],
    {
      'total_deposit_fees' : bigint,
      'total_withdraw_fees' : bigint,
      'total_ledger_fees' : bigint,
      'accumulated_fees' : bigint,
    }
  >,
  'get_log' : ActorMethod<[], Array<string>>,
  'get_sgldt_balance' : ActorMethod<[], bigint>,
  ...
  'is_authorized_fee_collector' : ActorMethod<[Principal], boolean>,
