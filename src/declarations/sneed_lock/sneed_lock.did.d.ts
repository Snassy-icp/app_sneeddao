...
export type CreateLockResult = { 'Ok' : LockId } |
  { 'Err' : CreateLockError };
export type CreateLockResult__1 = { 'Ok' : LockId } |
  { 'Err' : CreateLockError };
export type Dex = bigint;
export type Expiry = bigint;
export type Expiry__1 = bigint;
...
export interface SneedLock {
  ...
  'create_lock' : ActorMethod<[bigint, Principal, Expiry], CreateLockResult__1>,
  ...
  >,
  'get_summed_locks' : ActorMethod<[], Array<[TokenType__1, Balance__1]>>,
  ...
  'get_token_locks' : ActorMethod<
    [],
    Array<[LockId, TokenType__1, Balance__1, Expiry]>
  >,
...
export type TokenType__1 = Principal;
