...
// Migration expression to add canister_kind field to CanisterAsset
(with migration = func (old : { var offers : [{
    ...
    assets : [{
        asset : {
            #Canister : { canister_id : Principal; controllers_snapshot : ?[Principal] };
            ...
            }) : T.Offer {
                {
                    ...
                    assets = Array.map(
                        ...
                        func (ae : {
                            ...
                            {
                                asset = switch (ae.asset) {
                                    case (#Canister(c)) {
                                        #Canister({
                                            canister_id = c.canister_id;
                                            canister_kind = null; // New field
