...
// Migration: Add `key: Text` field to ActionConfig in tradeChoreActions and moveFundsActions.
// Remove this migration expression after successful deployment.
(with migration = func (old : {
    var tradeChoreActions : [(Text, [{
        id : Nat;
        actionType : Nat;
        enabled : Bool;
        ...
        executionCount : Nat;
        trailingStopWatermarkE8s : ?Nat;
    }])];
    var moveFundsActions : [(Text, [{
        id : Nat;
        actionType : Nat;
        enabled : Bool;
        inputToken : Principal;
    ...
    type OldAction = {
        id : Nat; actionType : Nat; enabled : Bool;
        inputToken : Principal; outputToken : ?Principal;
        minAmount : Nat; maxAmount : Nat; amountMode : Nat; balancePercent : ?Nat;
        preferredDex : ?Nat; sourcePurseId : ?Text; targetPurseId : ?Text;
        destinationOwner : ?Principal; destinationSubaccount : ?Blob;
        minBalance : ?Nat; maxBalance : ?Nat; balanceDenominationToken : ?Principal;
        minPrice : ?Nat; maxPrice : ?Nat; priceDenominationToken : ?Principal;
        maxPriceImpactBps : ?Nat; maxSlippageBps : ?Nat;
        minFrequencySeconds : ?Nat; maxFrequencySeconds : ?Nat;
        tradeSizeDenominationToken : ?Principal;
        trailingStopBps : ?Nat; trailingStopDirection : ?Nat; trailingStopResetOnExec : ?Nat;
        haltChoreAfterExecution : Bool;
        maxCumulativeInput : ?Nat; maxCumulativeOutput : ?Nat; maxExecutions : ?Nat;
        lastExecutedAt : ?Int; cumulativeInputSpent : Nat; cumulativeOutputReceived : Nat;
        executionCount : Nat; trailingStopWatermarkE8s : ?Nat;
    };
    func migrateAction(o : OldAction) : T.ActionConfig {
        {
            id = o.id; key = ""; actionType = o.actionType; enabled = o.enabled;
            inputToken = o.inputToken; outputToken = o.outputToken;
            minAmount = o.minAmount; maxAmount = o.maxAmount;
            amountMode = o.amountMode; balancePercent = o.balancePercent;
            preferredDex = o.preferredDex; sourcePurseId = o.sourcePurseId;
            targetPurseId = o.targetPurseId;
            destinationOwner = o.destinationOwner; destinationSubaccount = o.destinationSubaccount;
            minBalance = o.minBalance; maxBalance = o.maxBalance;
            balanceDenominationToken = o.balanceDenominationToken;
            minPrice = o.minPrice; maxPrice = o.maxPrice;
            priceDenominationToken = o.priceDenominationToken;
            maxPriceImpactBps = o.maxPriceImpactBps; maxSlippageBps = o.maxSlippageBps;
            minFrequencySeconds = o.minFrequencySeconds; maxFrequencySeconds = o.maxFrequencySeconds;
            tradeSizeDenominationToken = o.tradeSizeDenominationToken;
            trailingStopBps = o.trailingStopBps; trailingStopDirection = o.trailingStopDirection;
            trailingStopResetOnExec = o.trailingStopResetOnExec;
            haltChoreAfterExecution = o.haltChoreAfterExecution;
            maxCumulativeInput = o.maxCumulativeInput; maxCumulativeOutput = o.maxCumulativeOutput;
            maxExecutions = o.maxExecutions;
            lastExecutedAt = o.lastExecutedAt; cumulativeInputSpent = o.cumulativeInputSpent;
            cumulativeOutputReceived = o.cumulativeOutputReceived;
            executionCount = o.executionCount; trailingStopWatermarkE8s = o.trailingStopWatermarkE8s;
        }
    };
    {
        var tradeChoreActions = Array.map<(Text, [OldAction]), (Text, [T.ActionConfig])>(
            old.tradeChoreActions, func ((id, actions)) {
                (id, Array.map<OldAction, T.ActionConfig>(actions, migrateAction))
            }
        );
        var moveFundsActions = Array.map<(Text, [OldAction]), (Text, [T.ActionConfig])>(
            old.moveFundsActions, func ((id, actions)) {
                (id, Array.map<OldAction, T.ActionConfig>(actions, migrateAction))
            }
        );
    }
