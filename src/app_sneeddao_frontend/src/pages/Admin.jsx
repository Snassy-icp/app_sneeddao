            ...
            <main className="wallet-container">
                ...
                <div style={{ 
                    ...
                    <Link 
                        ...
                        onMouseLeave={e => e.currentTarget.style.transform = 'scale(1)'}
                    >
                        <h2 style={{ margin: 0 }}>Sneedapp</h2>
                        <p style={{ color: '#06b6d4', margin: 0 }}>Manage apps, versions, WASM uploads, and mint log</p>
                    </Link>
                    ...
                    <Link 
                        ...
                        onMouseLeave={e => e.currentTarget.style.transform = 'scale(1)'}
                    >
                        <h2 style={{ margin: 0 }}>💰 Profits</h2>
                        <p style={{ color: '#aaa', margin: 0 }}>View profits from all products with USD estimates</p>
                    </Link>
                    ...
                    <Link 
                        ...
                        onMouseLeave={e => e.currentTarget.style.transform = 'scale(1)'}
                    >
                        <h2 style={{ margin: 0 }}>Token Whitelist</h2>
                        <p style={{ color: '#888', margin: 0 }}>Manage whitelisted tokens for dropdowns</p>
                    </Link>

                    <Link 
                        to="/admin/sns_jailbreak"
                        style={{
                            backgroundColor: '#2a2a2a',
                            padding: '20px',
                            borderRadius: '8px',
